...
![Figure: AutoGaze 효율성 개요 — 토큰 압축률과 1K프레임 4K 해상도 비디오 스케일링 비교](/images/posts/260327-autogaze/teaser_v21.png)
...
![Figure: AutoGaze 모델 아키텍처 — 컨볼루션 인코더와 오토레그레시브 트랜스포머 디코더의 구성](/images/posts/260327-autogaze/architecture_v15.png)
...
![Figure: AutoGaze의 정성적 결과 — 원본 비디오, 선택된 멀티스케일 패치, 복원 결과 비교](/images/posts/260327-autogaze/main_results.png)
...
![Figure: 비디오 벤치마크 성능 비교 테이블](/images/posts/260327-autogaze/mllm_benchmarks.png)

### 레이턴시 성능

![Figure: ViT 및 MLLM 레이턴시 성능 — AutoGaze 적용 전후 비교](/images/posts/260327-autogaze/latency_vision.png)
...
![Figure: OOD 일반화 — CCTV 영상, 로봇 비디오 등 학습 데이터에 없는 도메인에서의 동작](/images/posts/260327-autogaze/autogaze_ood_semantics_1.png)
