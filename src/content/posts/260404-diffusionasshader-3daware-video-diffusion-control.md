...
slug: 260404-diffusionasshader-3daware-video-diffusion-control
summary: '(EXCAI) | arXiv: 2501.03847 HuggingFace Space | Papers with Code Diffusion
  as Shader(DaS)는 3D 트래킹 비디오를 제어 입력으로 활용하여 비디오 디퓨전 프로세스를 본질적으로 3D-aware하게 만드는 새로운
  프레임워크이다'
author: MinHanr
publish_ready: true
cover:
...
### video generation research (영상생성 플랫폼) — 핵심 연관
