      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card>
          <CardHeader className="pb-2">
            ...
            <CardTitle className="text-2xl">{recentCount}</CardTitle>
          </CardHeader>
        </Card>
        <Card>
          <CardHeader className="pb-2">
            <CardDescription>활성 도메인</CardDescription>
            <CardTitle className="text-2xl">{sortedDomains.length}</CardTitle>
          </CardHeader>
        </Card>
        <Card>
          <CardHeader className="pb-2">
            <CardDescription>수집 갭</CardDescription>
            <CardTitle className="text-2xl">{gaps.length}개 폴더</CardTitle>
          </CardHeader>
        </Card>
      </div>
      ...
      {gaps.length > 0 && (
        <Card>
          ...
          <CardContent>
            <div className="space-y-2">
              {gaps.map((g) => (
                <div key={g.folder} className="flex items-center justify-between py-1.5 border-b border-neutral-800 last:border-0">
